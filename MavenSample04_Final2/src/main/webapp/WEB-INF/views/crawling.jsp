...
<body>
   ...
   <div id="main-wrapper">
            ...
            <nav class="navbar navbar-expand">
               <div class="collapse navbar-collapse justify-content-between">
                  ...
                  <ul class="navbar-nav header-right">
                     ...
                     <!-- 프로필 닉네임 -->
                     <span style="color:#593BDB; font-weight: 700;">NICKNAME</span>
                  </div>
                     <!-- 프로필 드롭다운 -->
                        <div class="dropdown-menu dropdown-menu-right">
                           <ul class="list-unstyled">
                              <li class="media dropdown-item"><span class="success">
                                ...
                                <!-- 변경한 이미지 img -->
                                <!-- <img class="ti-user" src="assets/images/memberprofileimg/1.png" width = "30px" height = "30px" style="border-radius: 15px; margin-right: 10px;"> -->
                                 <!-- 원래 드롭다운 i태그 -->
                                 <i class="ti-user"></i>
                     ...
                     <li class="nav-item dropdown header-profile"><a
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                           <a href="WEB-INF/views/gopage-mypage.do" class="dropdown-item"> <i
                              class="icon-user"></i> <span class="ml-2">MyPage </span>
                           </a> 
                           <a href="WEB-INF/views/gopage-login.do" class="dropdown-item"> <i
            ...
            <div class ="ourcontentdetail">
               ...
               <div class ="ourflexcontentdetailtop">
                  ...
                  <div class="ourimgwrap">
                     <img src = "assets/images/${contest.conName}.jpg" width="600px" height="650px">
                  </div>
                  ...
                  <div class="ourpositonrelative">
                     ...
                     <div>
                        ...
                        <!-- 4문단 txt-->
                        <div class="ourpttxt">
                        ${contest.conStartDate} ~ ${contest.conEndDate} ${contest.conEndTime}
                        </div>
                     </div>
                     ...
                     <div>
                        ...
                        <!-- 8문단 txt-->
                        <div class="ourpttxt" >
                           <a href="https://www.ottogi.co.kr/brand/brands_contest_outline" style="color: black;"><u>${contest.conHomepage}</u></a>
                        </div>
                     </div>
                     <div class="ourbuttonframe">
                     <c:choose>
		<c:when test="${scrapconNamesList.contains(contest.conName)}">
			<button id="scrapBtn" class="ourcustom-btn btn-7" type="button">스크랩취소</button>
		</c:when>
		<c:otherwise>
			<button id="scrapBtn" class="ourcustom-btn btn-7" type="button">스크랩하기</button>
		</c:otherwise>
	</c:choose>
                     </div>
         ...
         <div class = "ourcrwcontenttext">
            ...
            <P>
               <b>
                  <span style="font-size: 20px; font-weight: 700; color: black;">
                     ${contest.conName}
                  </span>
               </b>
            </P>
	...
	<input type="hidden" id="conStartDate" name="conStartDate"
		value="${contest.conStartDate}">
	<input type="hidden" id="conEndDate" name="conEndDate"
		value="${contest.conEndDate}">
